...
<script type="module">
    ...
    // 3. Extraer el ID de la URL (Ejemplo: /reportes/ABC123XYZ/edit)
    ...
    // Configurar el botón de cancelar dinámicamente
    ...
    function mostrarAlerta(mensaje, tipo = "success") {
        ...
        `;
        window.scrollTo(0, 0); // Sube la pantalla para ver el error
    }
