...
<div class="container mt-5">
    ...
    {{-- Contenido principal (Oculto hasta que Firebase responda) --}}
    <div id="report-content" class="card shadow-sm border-0 d-none">
        <div class="card-header d-flex justify-content-between align-items-center bg-white py-3">
            ...
            <div class="d-flex gap-2">
                {{-- Nota: El href del botón editar lo asignaremos desde JS --}}
        ...
        <div class="card-body p-4">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="text-center bg-light border rounded p-2 shadow-sm" id="rep-img-container">
                        {{-- Aquí JavaScript inyectará la imagen o el ícono de "no imagen" --}}
                    </div>
                </div>
            </div>
            ...
            {{-- Sección de Gestión (Sin Formulario, 100% JS) --}}
...
<script type="module">
    ...
    // 3. Extraer el ID del reporte desde la URL (Ejemplo: misitio.com/reportes/XYZ123)
    ...
    async function cargarDetalleReporte() {
        try {
            ...
            if (docSnap.exists()) {
                ...
                // Detalles extra (mostrar/ocultar)
    ...
    // Función disparada por los botones para guardar en Firebase (Hecha global para el onclick de HTML)
    window.actualizarEstatus = async function(nuevoEstatus) {
        try {
            ...
            await updateDoc(docRef, {
                ...
                updated_at: serverTimestamp() // Pone la hora actual del servidor de Firebase
            });
            ...
            cargarDetalleReporte(); // Recargar para revertir el botón si falló
        }
    };
